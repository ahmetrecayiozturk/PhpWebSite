...
if (is_logged_in()) {
    ...
    if (get_user_role() == 'admin') echo "<a href='bakiye_yukle.php'>Bakiye Yükle</a> | ";
    if (get_user_role() == 'firma_admin') echo "<a href='firma_panel.php'>Firma Paneli</a> | ";
    if (get_user_role() == 'admin') echo "<a href='admin_panel.php'>Admin Paneli</a> | <a href='admin_coupons.php'>Kuponlar</a> | ";
